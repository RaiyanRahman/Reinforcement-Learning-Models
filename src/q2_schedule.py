...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        # Check if t is still to be updated.
        if t <= self.nsteps:
            # Calculate the step size.
            distance = self.eps_begin - self.eps_end
            step_size = distance / self.nsteps
            # Update epsilon.
            self.epsilon = self.eps_begin - (step_size * t)
        # Otherwise, set epsilon to the end value.
        else:
